...
#ifdef _LP64
    // if there is any conflict use the stack
    if (arg1 == c_rarg2 || arg1 == c_rarg3 || arg1 == c_rarg4 || arg1 == c_rarg5 ||
        arg2 == c_rarg1 || arg2 == c_rarg3 || arg2 == c_rarg4 || arg2 == c_rarg5 ||
        arg3 == c_rarg1 || arg3 == c_rarg2 || arg3 == c_rarg4 || arg3 == c_rarg5 ||
        arg4 == c_rarg1 || arg4 == c_rarg2 || arg4 == c_rarg3 || arg4 == c_rarg5 ||
        arg5 == c_rarg1 || arg5 == c_rarg2 || arg5 == c_rarg3 || arg5 == c_rarg4) {
      push(arg5);
      push(arg4);
      push(arg3);
      push(arg2);
      ...
      case fast_new_instance_init_check_id:
        {
          ...
          if (ColorObjectAllocations) {
            ...
            int call_offset = __ call_RT(obj, noreg, CAST_FROM_FN_PTR(address,
                                 new_colored_instance), klass, method, bci);
    ...
    case new_object_array_id:
      {
        ...
        if ((!CompileSlowAllocations) && UseTLAB && FastTLABRefill) {
          Label slow_path;
        ...
        OopMap* map;
        if (ColorObjectAllocations) {
          Register method = rcx, bci = rdi;
          __ enter();
          map = save_live_registers(sasm, 5);
          // retrieve bci -- method is already in the register
          __ movl(bci, Address(rbp, 2*BytesPerWord));
          if (id == new_type_array_id) {
            call_offset = __ call_RT(obj, noreg, CAST_FROM_FN_PTR(address, new_colored_type_array), klass, length, method, bci);
          } else {
            call_offset = __ call_RT(obj, noreg, CAST_FROM_FN_PTR(address, new_colored_object_array), klass, length, method, bci);
          }
        } else {
          __ enter();
          map = save_live_registers(sasm, 3);
          if (id == new_type_array_id) {
