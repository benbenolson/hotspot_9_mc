...
class LIRGenerator: public InstructionVisitor, public BlockClosure {
 ...
 private:
  ...
  void new_instance    (LIR_Opr  dst, ciInstanceKlass* klass,
                        ciMethod* method, int bci, bool is_unresolved,
                        LIR_Opr  scratch1, LIR_Opr scratch2,
                        LIR_Opr scratch3,  LIR_Opr scratch4,
                        LIR_Opr klass_reg, LIR_Opr method_reg,
                        CodeEmitInfo* info);
