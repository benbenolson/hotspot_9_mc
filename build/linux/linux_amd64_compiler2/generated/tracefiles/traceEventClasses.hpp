...
public:
  void set_class(const char * value) { this->_class = value; }
  void set_name(const char * value) { this->_name = value; }
  void set_signature(const char * value) { this->_signature = value; }

  void writeStruct(TraceStream& ts) {
    ts.print_val("Class name", _class);
    ts.print(", ");
    ts.print_val("Method name", _name);
    ts.print(", ");
    ts.print_val("Method signature", _signature);
  }
};
...
class EventIntFlagChanged : public TraceEvent<EventIntFlagChanged>
{
 ...
 public:
  void set_name(const char * value) { this->_name = value; }
  void set_old_value(s4 value) { this->_old_value = value; }
  void set_new_value(s4 value) { this->_new_value = value; }
...
class EventUnsignedIntFlagChanged : public TraceEvent<EventUnsignedIntFlagChanged>
{
 ...
 public:
  void set_name(const char * value) { this->_name = value; }
  void set_old_value(unsigned value) { this->_old_value = value; }
  void set_new_value(unsigned value) { this->_new_value = value; }
  void set_origin(u1 value) { this->_origin = value; }
...
class EventGCG1MMU : public TraceEvent<EventGCG1MMU>
{
 public:
  static const bool hasThread = false;
  static const bool hasStackTrace = false;
  static const bool isInstant = true;
  static const bool isRequestable = false;
  static const TraceEventId eventId = TraceGCG1MMUEvent;
 ...
 private:
  ...
  void writeEventContent(void) {
    ...
    ts.print_val("GC ID", _gcId);
    ts.print(", ");
    ts.print_val("Time slice used to calculate MMU", _timeSlice);
    ts.print(", ");
    ts.print_val("Time spent on GC during last time slice", _gcTime);
    ts.print(", ");
    ts.print_val("Max time allowed to be spent on GC during last time slice", _maxGcTime);
    ts.print("]\n");
  }

 public:
  void set_gcId(unsigned value) { this->_gcId = value; }
  void set_timeSlice(double value) { this->_timeSlice = value; }
  void set_gcTime(double value) { this->_gcTime = value; }
  void set_maxGcTime(double value) { this->_maxGcTime = value; }
  ...
  EventGCG1MMU(EventStartTime timing=TIMED) : TraceEvent<EventGCG1MMU>(timing) {}
...
class EventCompilerInlining : public TraceEvent<EventCompilerInlining>
{
 ...
 public:
  void set_compileID(unsigned value) { this->_compileID = value; }
  void set_caller(Method * value) { this->_caller = value; }
  void set_callee(const TraceStructCiMethod& value) { this->_callee = value; }
...
class EventCodeCacheFull : public TraceEvent<EventCodeCacheFull>
{
 ...
 public:
  void set_codeBlobType(u1 value) { this->_codeBlobType = value; }
...
{
public:
  void set_class(const char * value) { }
...
class EventIntFlagChanged : public TraceEvent
{
 public:
  ...
  void set_name(const char * value) { }
  void set_old_value(s4 value) { }
  void set_new_value(s4 value) { }
...
class EventUnsignedIntFlagChanged : public TraceEvent
{
 public:
  ...
  void set_name(const char * value) { }
  void set_old_value(unsigned value) { }
  void set_new_value(unsigned value) { }
  void set_origin(u1 value) { }
};
...
class EventGCG1MMU : public TraceEvent
{
 public:
  EventGCG1MMU(bool ignore=true) {}
  void set_gcId(unsigned value) { }
  void set_timeSlice(double value) { }
  void set_gcTime(double value) { }
  void set_maxGcTime(double value) { }
};
...
class EventCompilerInlining : public TraceEvent
{
 public:
  ...
  void set_compileID(unsigned value) { }
  void set_caller(Method * value) { }
  void set_callee(const TraceStructCiMethod& value) { }
...
class EventCodeCacheFull : public TraceEvent
{
 public:
  ...
  void set_codeBlobType(u1 value) { }
