...
const RegMask &loadV64Node::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &storeV64Node::out_RegMask() const { return (RegMask::Empty); }
const RegMask &Repl4B_memNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &Repl8B_memNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &Repl16BNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &Repl16B_memNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &Repl32BNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &Repl32B_memNode::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &Repl4S_memNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &Repl8SNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &Repl8S_memNode::out_RegMask() const { return (VECTORX_REG_mask()); }
...
const RegMask &Repl16S_memNode::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &Repl2F_memNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &Repl4F_memNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &Repl8FNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &Repl8F_memNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &Repl2D_memNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &Repl4DNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &Repl4D_memNode::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &Repl4B_mem_evexNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &Repl8B_mem_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &Repl16B_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &Repl16B_mem_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &Repl32B_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &Repl32B_mem_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &Repl64B_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl64B_mem_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl16B_imm_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &Repl32B_imm_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &Repl64B_imm_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl64B_zero_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl4S_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &Repl4S_mem_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &Repl8S_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &Repl8S_mem_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &Repl16S_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &Repl16S_mem_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &Repl32S_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl32S_mem_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl8S_imm_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &Repl16S_imm_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &Repl32S_imm_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl32S_zero_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl4I_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &Repl4I_mem_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &Repl8I_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &Repl8I_mem_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &Repl16I_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl16I_mem_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl4I_imm_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &Repl8I_imm_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &Repl16I_imm_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl16I_zero_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl4L_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &Repl8L_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl4L_imm_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &Repl8L_imm_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl2L_mem_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &Repl4L_mem_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &Repl8L_mem_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl8L_zero_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl8F_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &Repl8F_mem_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &Repl16F_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl16F_mem_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl16F_zero_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl4D_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &Repl4D_mem_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &Repl8D_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl8D_mem_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &Repl8D_zero_evexNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &rsadd2I_reduction_regNode::out_RegMask() const { return (INT_REG_mask()); }
const RegMask &rvadd2I_reduction_regNode::out_RegMask() const { return (INT_REG_mask()); }
const RegMask &rvadd2I_reduction_reg_evexNode::out_RegMask() const { return (INT_REG_mask()); }
const RegMask &rsadd4I_reduction_regNode::out_RegMask() const { return (INT_REG_mask()); }
const RegMask &rvadd4I_reduction_regNode::out_RegMask() const { return (INT_REG_mask()); }
const RegMask &rvadd4I_reduction_reg_evexNode::out_RegMask() const { return (INT_REG_mask()); }
const RegMask &rvadd8I_reduction_regNode::out_RegMask() const { return (INT_REG_mask()); }
const RegMask &rvadd8I_reduction_reg_evexNode::out_RegMask() const { return (INT_REG_mask()); }
const RegMask &rvadd16I_reduction_reg_evexNode::out_RegMask() const { return (INT_REG_mask()); }
const RegMask &rvadd2L_reduction_regNode::out_RegMask() const { return (LONG_REG_mask()); }
const RegMask &rvadd4L_reduction_regNode::out_RegMask() const { return (LONG_REG_mask()); }
const RegMask &rvadd8L_reduction_regNode::out_RegMask() const { return (LONG_REG_mask()); }
const RegMask &rsadd2F_reduction_regNode::out_RegMask() const { return (FLOAT_REG_mask()); }
const RegMask &rvadd2F_reduction_regNode::out_RegMask() const { return (FLOAT_REG_mask()); }
const RegMask &rsadd4F_reduction_regNode::out_RegMask() const { return (FLOAT_REG_mask()); }
const RegMask &rvadd4F_reduction_regNode::out_RegMask() const { return (FLOAT_REG_mask()); }
const RegMask &radd8F_reduction_regNode::out_RegMask() const { return (FLOAT_REG_mask()); }
const RegMask &radd16F_reduction_regNode::out_RegMask() const { return (FLOAT_REG_mask()); }
const RegMask &rsadd2D_reduction_regNode::out_RegMask() const { return (DOUBLE_REG_mask()); }
const RegMask &rvadd2D_reduction_regNode::out_RegMask() const { return (DOUBLE_REG_mask()); }
const RegMask &rvadd4D_reduction_regNode::out_RegMask() const { return (DOUBLE_REG_mask()); }
const RegMask &rvadd8D_reduction_regNode::out_RegMask() const { return (DOUBLE_REG_mask()); }
const RegMask &rsmul2I_reduction_regNode::out_RegMask() const { return (INT_REG_mask()); }
const RegMask &rvmul2I_reduction_regNode::out_RegMask() const { return (INT_REG_mask()); }
const RegMask &rsmul4I_reduction_regNode::out_RegMask() const { return (INT_REG_mask()); }
const RegMask &rvmul4I_reduction_regNode::out_RegMask() const { return (INT_REG_mask()); }
const RegMask &rvmul8I_reduction_regNode::out_RegMask() const { return (INT_REG_mask()); }
const RegMask &rvmul16I_reduction_regNode::out_RegMask() const { return (INT_REG_mask()); }
const RegMask &rvmul2L_reduction_regNode::out_RegMask() const { return (LONG_REG_mask()); }
const RegMask &rvmul4L_reduction_regNode::out_RegMask() const { return (LONG_REG_mask()); }
const RegMask &rvmul8L_reduction_regNode::out_RegMask() const { return (LONG_REG_mask()); }
const RegMask &rsmul2F_reductionNode::out_RegMask() const { return (FLOAT_REG_mask()); }
const RegMask &rvmul2F_reduction_regNode::out_RegMask() const { return (FLOAT_REG_mask()); }
const RegMask &rsmul4F_reduction_regNode::out_RegMask() const { return (FLOAT_REG_mask()); }
const RegMask &rvmul4F_reduction_regNode::out_RegMask() const { return (FLOAT_REG_mask()); }
const RegMask &rvmul8F_reduction_regNode::out_RegMask() const { return (FLOAT_REG_mask()); }
const RegMask &rvmul16F_reduction_regNode::out_RegMask() const { return (FLOAT_REG_mask()); }
const RegMask &rsmul2D_reduction_regNode::out_RegMask() const { return (DOUBLE_REG_mask()); }
const RegMask &rvmul2D_reduction_regNode::out_RegMask() const { return (DOUBLE_REG_mask()); }
const RegMask &rvmul4D_reduction_regNode::out_RegMask() const { return (DOUBLE_REG_mask()); }
const RegMask &rvmul8D_reduction_regNode::out_RegMask() const { return (DOUBLE_REG_mask()); }
...
const RegMask &vadd4B_memNode::out_RegMask() const { return (VECTORS_REG_mask()); }
...
const RegMask &vadd8B_memNode::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vadd64B_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vadd64B_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vadd2S_memNode::out_RegMask() const { return (VECTORS_REG_mask()); }
...
const RegMask &vadd4S_memNode::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vadd32S_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vadd32S_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vadd2I_memNode::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vadd16I_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vadd16I_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vadd8L_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vadd8L_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vadd2F_memNode::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vadd16F_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vadd16F_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vadd8D_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vadd8D_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vsub4B_memNode::out_RegMask() const { return (VECTORS_REG_mask()); }
...
const RegMask &vsub8B_memNode::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vsub64B_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vsub64B_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vsub2S_memNode::out_RegMask() const { return (VECTORS_REG_mask()); }
...
const RegMask &vsub4S_memNode::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vsub32S_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vsub32S_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vsub2I_memNode::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vsub16I_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vsub16I_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vsub8L_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vsub8L_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vsub2F_memNode::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vsub16F_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vsub16F_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vsub8D_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vsub8D_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vmul2S_memNode::out_RegMask() const { return (VECTORS_REG_mask()); }
...
const RegMask &vmul4S_memNode::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vmul32S_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vmul32S_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vmul2I_memNode::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vmul2L_regNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vmul2L_memNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vmul4L_regNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vmul4L_memNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vmul8L_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vmul8L_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vmul16I_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vmul16I_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vmul2F_memNode::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vmul16F_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vmul16F_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vmul8D_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vmul8D_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vdiv2F_memNode::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vdiv16F_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vdiv16F_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vdiv8D_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vdiv8D_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vsll32S_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vsll32S_reg_immNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vsll16I_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vsll16I_reg_immNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vsll8L_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vsll8L_reg_immNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vsrl32S_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vsrl32S_reg_immNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vsrl16I_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vsrl16I_reg_immNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vsrl8L_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vsrl8L_reg_immNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vsra32S_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vsra32S_reg_immNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vsra16I_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vsra16I_reg_immNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vand4B_memNode::out_RegMask() const { return (VECTORS_REG_mask()); }
...
const RegMask &vand8B_memNode::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vand64B_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vand64B_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vor4B_memNode::out_RegMask() const { return (VECTORS_REG_mask()); }
...
const RegMask &vor8B_memNode::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vor64B_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vor64B_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vxor4B_memNode::out_RegMask() const { return (VECTORS_REG_mask()); }
...
const RegMask &vxor8B_memNode::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vxor64B_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vxor64B_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
